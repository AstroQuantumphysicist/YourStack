/** Cross-cutting constants for the NodeRail platform. */
...
export const API_TOKEN_PREFIX = 'nr_';
export const JOIN_TOKEN_PREFIX = 'nrj_';
export const AGENT_TOKEN_PREFIX = 'nra_';
...
export const CONTAINER_PREFIX = 'noderail';
export const DOCKER_LABEL_NAMESPACE = 'io.noderail';
